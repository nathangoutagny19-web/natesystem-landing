...
const COPY: Record<Lang, BookCopy> = {
  fr: {
    ...
    step1TitleAccent: 'appel · offert.',
    step1Sub: 'Un appel pour évaluer si on peut bosser ensemble. Pire des cas : vous repartez avec une roadmap IA sur-mesure. Meilleur des cas : on bosse ensemble.',
    ...
    audit4Sub: 'Pour prioriser les recommandations de votre appel.',
  ...
  en: {
    ...
    step1TitleAccent: 'free call.',
    step1Sub: 'A call to see if we can work together. Worst case: you leave with a custom AI roadmap. Best case: we work together.',
    ...
    audit4Sub: 'To prioritize the recommendations for your 20-min call.',
  ...
  hu: {
    step1Label: '1/3. LÉPÉS · ADATOK',
    step1Title: 'Foglalja le az',
    step1TitleAccent: 'ingyenes hívását.',
    step1Sub:
      'Egy hívás, hogy kiderüljön, tudunk-e együtt dolgozni. Legrosszabb esetben egy Önre szabott MI-ütemtervvel távozik. Legjobb esetben együtt dolgozunk.',
    fieldFirstName: 'Keresztnév',
    fieldFirstNamePh: 'A keresztneve',
    ...
    fieldTeamSize: 'Csapatméret',
    fieldChallenge: 'Fő kihívás',
    fieldBudget: 'Tervezett éves keret',
    fieldDetails: 'Kiegészítés (nem kötelező)',
    fieldDetailsPh: 'Írja le röviden a helyzetét...',
    step1Cta: 'Tovább → Villámdiagnosztika',
    step1Reassurance: 'Ingyenes · Kötelezettség nélkül · Az adatai bizalmasak maradnak',
    auditStepLabel: '2/3. LÉPÉS · VILLÁMDIAGNOSZTIKA',
    audit1Title: 'A jelenlegi',
    audit1TitleAccent: 'eszközei.',
    audit1Sub: 'Hogy megértsük a technikai környezetét, és meglássuk a gyors nyereségeket.',
    audit1QTools: 'Milyen eszközöket használ nap mint nap?',
    audit1QSaas: 'Hány SaaS-előfizetést fizet?',
    audit1QConnected: 'Beszélnek egymással az eszközei?',
    audit2Title: 'Az ismétlődő',
    audit2TitleAccent: 'feladatai.',
    audit2Sub: 'Hogy meglássuk, mi automatizálható azonnal.',
    audit2QTasks: 'Mely feladatok viszik el hetente a legtöbb időt?',
    audit2QHours: 'Hány órát tölt a csapata hetente ezekkel a feladatokkal?',
    audit2QWho: 'Ki végzi őket elsősorban?',
    audit3Title: 'A folyamatai',
    audit3TitleAccent: 'és adatai.',
    audit3Sub: 'Hogy felmérjük a jelenlegi infrastruktúrája érettségét.',
    audit3QProcess: 'Le vannak írva a belső folyamatai?',
    audit3QData: 'Hol élnek a kritikus adatai?',
    audit3QAbsence: 'Mi történik, ha egy kulcsember hiányzik?',
    audit4Title: 'A céljai',
    audit4TitleAccent: 'és a sürgősség.',
    audit4Sub: 'Hogy rangsorolni tudjuk a hívásán elhangzó javaslatokat.',
    audit4QResults: 'Milyen eredményre mondaná 90 nap múlva, hogy „megérte”?',
    audit4QUrgency: 'Mennyire sürgős?',
    audit4QTried: 'Próbálta már megoldani ezt a problémát?',
    back: '← Vissza',
    next: 'Tovább →',
    sending: 'Küldés...',
    seeSlots: 'Időpontok megtekintése →',
    calDone: 'DIAGNOSZTIKA KÉSZ',
    calTitle: 'Válassza ki',
    calTitleAccent: 'az időpontját.',
    calSub: (n: string) => `Köszönjük, ${n}! A válaszait elmentettük. Foglaljon időpontot alább, hamarosan találkozunk.`,
    roles: ['Tulajdonos / ügyvezető', 'Marketingvezető', 'Értékesítési vezető', 'Működési vezető / COO', 'HR-vezető', 'IT-vezető / CTO', 'Tanácsadó', 'Egyéb'],
    sectors: ['Vendéglátás / szálláshely', 'Tanácsadás / szolgáltatás', 'Építőipar / ingatlan', 'Kereskedelem', 'Ipar', 'Oktatás', 'Egészségügy', 'Tech / SaaS', 'Egyéb'],
    teamSizes: ['1-5 fő', '6-20 fő', '21-50 fő', '51-100 fő', '100+ fő'],
    challenges: [
      'Túl sok eszköz, amelyek nem beszélnek egymással',
      'Ismétlődő feladatok, amelyek túl sok időt visznek',
      'Szétszórt, kihasználatlan adatok',
      'Leíratlan folyamatok',
      'Nehéz növekedni új munkaerő felvétele nélkül',
      'Egyéb',
    ],
    ...
    toolsList: [
      'Google Workspace', 'Microsoft 365', 'Slack', 'Notion', 'HubSpot', 'Salesforce',
      'Airtable', 'Excel / Sheets', 'Monday', 'Trello', 'Asana', 'Pipedrive',
      'Odoo', 'Számlázó / könyvelőprogram', 'LinkedIn', 'Instagram / Meta', 'WhatsApp Business',
      'AWS', 'Google Cloud', 'Azure', 'OVH', 'Belső / egyedi eszközök', 'Egyéb',
    ],
    saasCounts: ['1-3', '4-7', '8-12', '13+', 'Fogalmam sincs'],
    toolsConnected: [
      'Igen, integrációkkal vagy Zapierrel/Make-kel',
      'Részben (gyakori a másolás-beillesztés)',
      'Nem, minden külön szigeten van',
      'Nem tudom',
    ],
    repetitiveTasks: [
      'Adatbevitel / adatátmozgatás',
      'Beosztás / ütemezés',
      'Riportálás / irányítópultok',
      'Ügyfél- és érdeklődő-utánkövetés',
      'Számlázás / árajánlatok',
      'Munkatársak / ügyfelek bevezetése',
      'Belső kommunikáció',
      'Készlet- és rendeléskezelés',
      'Egyéb',
    ],
    hoursWasted: ['Heti 5 óránál kevesebb', 'Heti 5-10 óra', 'Heti 10-20 óra', 'Heti 20-40 óra', 'Heti 40+ óra'],
    whoDoesIt: ['A cégvezető', 'Egy vezető', 'Több ember', 'Mindenki egy kicsit', 'Asszisztens / irodavezető'],
    processDocs: ['Igen, teljesen', 'Részben', 'Nem, minden a fejekben van', 'Nekifutottunk, de nem naprakész'],
    dataLocations: ['CRM', 'Excel- / Sheets-fájlok', 'E-mailek', 'Az emberek fejében', 'ERP / szakmai szoftver', 'Papír', 'Adatbázis', 'Egyéb'],
    absenceImpact: [
      'Semmi nem halad, várunk',
      'Elboldogulunk, de káosz van',
      'Egy kolléga könnyen átveszi',
      'Vannak leírt helyettesítési folyamataink',
    ],
    desiredResults: [
      'Heti 10+ óra nyeresége',
      'Kevesebb működési hiba',
      'Ne függjünk egyetlen kulcsembertől',
      'Valós idejű irányítópult',
      'Automatizált ügyfélszerzés és utánkövetés',
      'Alacsonyabb SaaS-költség',
      'Növekedés új munkaerő nélkül',
    ],
    urgency: [
      'Kritikus, minden héten pénzt veszítünk',
      'Fontos, a következő 3 hónapban',
      'Jó lenne, ha lesz rá időnk',
      'Csak körülnézek',
    ],
    triedBefore: [
      'Nem, soha',
      'Igen, szabadúszóval / tanácsadóval',
      'Igen, egy eszközzel (Zapier, Make...)',
      'Igen, házon belül, de nem vált be',
    ],
  },
}
