...
const pains = [
  ...
  'Une croissance rapide que vos outils actuels ne suivent plus',
...
export default function LogicielInterneAnnecyPage() {
  return (
    <main>
      <Nav />
      ...
      <section style={{ padding: '160px 24px 40px' }}>
        <div className="mx-auto text-center" style={{ maxWidth: 820 }}>
          <FadeUp>
            <span className="section-label">Logiciel interne · Annecy</span>
            <h1 className="font-serif italic" style={{ fontSize: 'clamp(30px, 5.2vw, 52px)', fontWeight: 400, lineHeight: 1.1, color: 'var(--text)', maxWidth: 800, margin: '14px auto 24px' }}>
              Logiciel interne à Annecy : la solution sur-mesure qui <span className="accent" style={{ color: 'var(--accent)' }}>fait grandir votre entreprise.</span>
            </h1>
        ...
        <div className="mx-auto" style={{ maxWidth: 760 }}>
          ...
          <FadeUp>
            <p className="font-sans" style={{ fontSize: 16, color: 'var(--text-secondary)', lineHeight: 1.75, fontWeight: 300, maxWidth: 680, margin: '0 auto', textAlign: 'center' }}>
              ...
              entre tableurs, mails et outils déconnectés : gestion, données, équipe, pilotage. À Annecy, NateSystem conçoit
      ...
      <section style={{ padding: '70px 24px' }}>
        <div className="mx-auto" style={{ maxWidth: 760 }}>
          <FadeUp className="text-center mb-8">
            <h2 className="section-title" style={{ maxWidth: 640, margin: '0 auto' }}>
              Une solution pensée pour les entreprises <span className="accent">d'Annecy.</span>
            </h2>
          </FadeUp>
          <FadeUp>
            ...
            <p className="font-sans" style={{ fontSize: 15.5, color: 'var(--text-secondary)', lineHeight: 1.75, fontWeight: 300, maxWidth: 680, margin: '0 auto', textAlign: 'center' }}>
              On intervient aussi à <Link href="/logiciel-interne-chambery" style={{ color: 'var(--accent)', textDecoration: 'none' }}>Chambéry</Link> et
              dans toute l'Auvergne-Rhône-Alpes. Le développement se fait à distance et en présentiel selon vos besoins.
            </p>
          </FadeUp>
        </div>
      </section>
        ...
        <div className="mx-auto" style={{ maxWidth: 760 }}>
          ...
          <div style={{ display: 'grid', gap: 22, maxWidth: 680, margin: '0 auto' }}>
            {[
              ...
              {
                q: 'Combien coûte un logiciel interne à Annecy ?',
                a: 'Le prix dépend du périmètre, des intégrations et de l\'IA. Pour une PME d\'Annecy, une première version utile se situe entre quelques milliers et quelques dizaines de milliers d\'euros. On chiffre l\'impact avant le devis, pendant l\'audit offert.',
              },
              {
                q: 'Intervenez-vous uniquement à Annecy ?',
                a: 'NateSystem accompagne les entreprises d\'Annecy, de toute la Haute-Savoie et de l\'Auvergne-Rhône-Alpes, dont Chambéry et Lyon. Le travail se fait à distance et en présentiel selon les besoins.',
              },
            ].map((item) => (
              <div key={item.q}>
          ...
          <FadeUp>
            <div style={{ background: 'var(--bg-card)', border: '1px solid rgba(230,57,70,0.15)', borderRadius: 12, padding: '48px 40px', textAlign: 'center' }}>
              <h2 className="font-serif italic" style={{ fontSize: 'clamp(24px, 4vw, 32px)', fontWeight: 400, marginBottom: 16, color: 'var(--text)' }}>
                Votre logiciel interne, à Annecy.
              </h2>
