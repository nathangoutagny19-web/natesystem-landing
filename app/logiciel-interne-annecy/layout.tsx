...
export const metadata: Metadata = {
  ...
  description:
    'Logiciel interne à Annecy : NateSystem conçoit des solutions logicielles sur-mesure pour entreprise — gestion, données, équipe. Code livré, propriété 100 %, hébergé en UE. Audit offert de 20 min.',
  ...
  twitter: {
    ...
    title: 'Logiciel interne Annecy : solution sur-mesure entreprise',
    description: 'Solutions logicielles internes sur-mesure pour entreprise à Annecy. Code livré, propriété 100 %, hébergé en UE.',
  },
}
  ...
  '@graph': [
    {
      ...
      address: { '@type': 'PostalAddress', addressLocality: 'Annecy', addressRegion: 'Auvergne-Rhône-Alpes', addressCountry: 'FR' },
    },
    {
      '@type': 'Service',
      ...
      description:
        'Conception et déploiement de logiciels internes sur-mesure pour les entreprises d\'Annecy : outil métier unique, gestion des données, dashboards, IA intégrée. Code source livré, hébergement UE, RGPD-natif.',
    },
    {
      '@type': 'FAQPage',
      mainEntity: [
        {
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Un logiciel interne est une application métier développée pour l\'usage propre d\'une entreprise, au lieu d\'un logiciel standard du marché. Il réunit en un seul système ce que vous éparpillez entre tableurs et outils déconnectés : gestion, données, équipe, pilotage. À Annecy, NateSystem conçoit ces solutions logicielles sur-mesure pour que l\'entreprise en soit propriétaire.',
          },
        },
        {
          '@type': 'Question',
        ...
        {
          '@type': 'Question',
          name: 'Combien coûte un logiciel interne à Annecy ?',
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Le prix dépend du périmètre (un process ou une plateforme complète), des intégrations et de l\'IA. Pour une PME d\'Annecy, une première version utile se situe entre quelques milliers et quelques dizaines de milliers d\'euros. On chiffre l\'impact (heures et euros gagnés) avant le devis, pendant l\'audit offert.',
          },
        },
        {
          '@type': 'Question',
          name: 'Intervenez-vous uniquement à Annecy ?',
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'NateSystem accompagne les entreprises d\'Annecy, de toute la Haute-Savoie et de la région Auvergne-Rhône-Alpes (dont Chambéry et Lyon). Le travail se fait à distance et en présentiel selon les besoins, partout en France.',
          },
        },
      ],
    },
...
export default function LogicielInterneAnnecyLayout({ children }: { children: React.ReactNode }) {
  return (
    <>
