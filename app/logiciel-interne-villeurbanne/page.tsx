...
export default function LogicielInterneVilleurbannePage() {
  return (
    <main>
      <Nav />
      ...
      <section style={{ padding: '160px 24px 40px' }}>
        <div className="mx-auto text-center" style={{ maxWidth: 820 }}>
          <FadeUp>
            <span className="section-label">Logiciel interne · Villeurbanne</span>
            <h1 className="font-serif italic" style={{ fontSize: 'clamp(30px, 5.2vw, 52px)', fontWeight: 400, lineHeight: 1.1, color: 'var(--text)', maxWidth: 800, margin: '14px auto 24px' }}>
              Logiciel interne à Villeurbanne : la solution sur-mesure qui <span className="accent" style={{ color: 'var(--accent)' }}>fait grandir votre entreprise.</span>
            </h1>
        ...
        <div className="mx-auto" style={{ maxWidth: 760 }}>
          ...
          <FadeUp>
            <p className="font-sans" style={{ fontSize: 16, color: 'var(--text-secondary)', lineHeight: 1.75, fontWeight: 300, maxWidth: 680, margin: '0 auto', textAlign: 'center' }}>
              ...
              entre tableurs, mails et outils déconnectés : gestion, données, équipe, pilotage. À Villeurbanne, NateSystem
              conçoit ces solutions logicielles sur-mesure pour que votre entreprise en soit propriétaire.
            </p>
          </FadeUp>
        </div>
      </section>
      ...
      {/* Why Villeurbanne / local */}
      <section style={{ padding: '70px 24px' }}>
        <div className="mx-auto" style={{ maxWidth: 760 }}>
          <FadeUp className="text-center mb-8">
            <h2 className="section-title" style={{ maxWidth: 640, margin: '0 auto' }}>
              Une agence proche de <span className="accent">Villeurbanne</span> et de vos équipes.
            </h2>
          </FadeUp>
          <FadeUp>
            <p className="font-sans" style={{ fontSize: 15.5, color: 'var(--text-secondary)', lineHeight: 1.75, fontWeight: 300, maxWidth: 680, margin: '0 auto 16px', textAlign: 'center' }}>
              Villeurbanne, dans l'agglomération lyonnaise, c'est un tissu dense de PME, de commerces et de
              services, avec un vrai pôle universitaire autour du campus de la Doua. Beaucoup d'entreprises sont à deux
              pas de Lyon, mais ont leurs propres besoins, leurs propres process et leurs propres données à gérer. NateSystem
              part du terrain pour construire le logiciel interne qui correspond à votre métier réel.
            </p>
            <p className="font-sans" style={{ fontSize: 15.5, color: 'var(--text-secondary)', lineHeight: 1.75, fontWeight: 300, maxWidth: 680, margin: '0 auto', textAlign: 'center' }}>
              Basé juste à côté, à <Link href="/logiciel-interne-lyon" style={{ color: 'var(--accent)', textDecoration: 'none' }}>Lyon</Link>, on
              accompagne les entreprises de Villeurbanne, du Rhône et de toute l'Auvergne-Rhône-Alpes, avec un
              interlocuteur proche et disponible. Le développement se fait à distance et en présentiel selon vos besoins.
            </p>
          </FadeUp>
        </div>
      </section>
        ...
        <div className="mx-auto" style={{ maxWidth: 760 }}>
          ...
          <div style={{ display: 'grid', gap: 22, maxWidth: 680, margin: '0 auto' }}>
            {[
              ...
              {
                q: 'Combien coûte un logiciel interne à Villeurbanne ?',
                a: 'Le prix dépend du périmètre, des intégrations et de l\'IA. Pour une PME de Villeurbanne, une première version utile se situe entre quelques milliers et quelques dizaines de milliers d\'euros. On chiffre l\'impact avant le devis, pendant l\'audit offert.',
              },
              {
                q: 'Intervenez-vous uniquement à Villeurbanne ?',
                a: 'NateSystem est basé à Lyon, juste à côté de Villeurbanne, et accompagne les entreprises de Villeurbanne, du Rhône et de toute l\'Auvergne-Rhône-Alpes. Le travail se fait à distance et en présentiel selon les besoins.',
              },
            ].map((item) => (
              <div key={item.q}>
          ...
          <FadeUp>
            <div style={{ background: 'var(--bg-card)', border: '1px solid rgba(230,57,70,0.15)', borderRadius: 12, padding: '48px 40px', textAlign: 'center' }}>
              <h2 className="font-serif italic" style={{ fontSize: 'clamp(24px, 4vw, 32px)', fontWeight: 400, marginBottom: 16, color: 'var(--text)' }}>
                Votre logiciel interne, à Villeurbanne.
              </h2>
