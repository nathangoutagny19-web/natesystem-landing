...
export default function LogicielInterneGrenoblePage() {
  return (
    <main>
      <Nav />
      ...
      <section style={{ padding: '160px 24px 40px' }}>
        <div className="mx-auto text-center" style={{ maxWidth: 820 }}>
          <FadeUp>
            <span className="section-label">Logiciel interne · Grenoble</span>
            <h1 className="font-serif italic" style={{ fontSize: 'clamp(30px, 5.2vw, 52px)', fontWeight: 400, lineHeight: 1.1, color: 'var(--text)', maxWidth: 800, margin: '14px auto 24px' }}>
              Logiciel interne à Grenoble : la solution sur-mesure qui <span className="accent" style={{ color: 'var(--accent)' }}>fait grandir votre entreprise.</span>
            </h1>
        ...
        <div className="mx-auto" style={{ maxWidth: 760 }}>
          ...
          <FadeUp>
            <p className="font-sans" style={{ fontSize: 16, color: 'var(--text-secondary)', lineHeight: 1.75, fontWeight: 300, maxWidth: 680, margin: '0 auto', textAlign: 'center' }}>
              ...
              entre tableurs, mails et outils déconnectés : gestion, données, équipe, pilotage. À Grenoble, NateSystem conçoit
              ces solutions logicielles sur-mesure pour que votre entreprise en soit propriétaire.
            </p>
          </FadeUp>
        </div>
      </section>
      ...
      <section style={{ padding: '70px 24px' }}>
        <div className="mx-auto" style={{ maxWidth: 760 }}>
          <FadeUp className="text-center mb-8">
            <h2 className="section-title" style={{ maxWidth: 640, margin: '0 auto' }}>
              Un partenaire logiciel proche de <span className="accent">l'écosystème grenoblois.</span>
            </h2>
          </FadeUp>
          <FadeUp>
            ...
            <p className="font-sans" style={{ fontSize: 15.5, color: 'var(--text-secondary)', lineHeight: 1.75, fontWeight: 300, maxWidth: 680, margin: '0 auto', textAlign: 'center' }}>
              On commence par comprendre votre activité sur le terrain, puis on construit la solution qui correspond à vos
              vrais besoins. Basés à <Link href="/logiciel-interne-lyon" style={{ color: 'var(--accent)', textDecoration: 'none' }}>Lyon</Link>, nous
              accompagnons les entreprises de Grenoble, de l'Isère et de toute l'Auvergne-Rhône-Alpes, à distance et
              en présentiel selon vos besoins.
            </p>
          </FadeUp>
        </div>
      </section>
          ...
          <div style={{ display: 'grid', gap: 22, maxWidth: 680, margin: '0 auto' }}>
            {[
              ...
              },
              {
                ...
                a: 'Le prix dépend du périmètre, des intégrations et de l\'IA. Pour une PME grenobloise, une première version utile se situe entre quelques milliers et quelques dizaines de milliers d\'euros. On chiffre l\'impact avant le devis, pendant l\'audit offert.',
              },
              {
                q: 'Intervenez-vous uniquement à Grenoble ?',
                a: 'NateSystem est basé à Lyon et accompagne les entreprises de Grenoble, de l\'Isère et de toute l\'Auvergne-Rhône-Alpes. Le travail se fait à distance et en présentiel selon les besoins.',
              },
            ].map((item) => (
              <div key={item.q}>
          ...
          <FadeUp>
            <div style={{ background: 'var(--bg-card)', border: '1px solid rgba(230,57,70,0.15)', borderRadius: 12, padding: '48px 40px', textAlign: 'center' }}>
              <h2 className="font-serif italic" style={{ fontSize: 'clamp(24px, 4vw, 32px)', fontWeight: 400, marginBottom: 16, color: 'var(--text)' }}>
                Votre logiciel interne, à Grenoble.
              </h2>
