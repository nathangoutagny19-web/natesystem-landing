    ...
    >
      ...
      >
        ...
        <Section title="Responsable du traitement">
          <p>
            <strong>Nathan Goutagny — NateSystem</strong>
          </p>
          <p>
        ...
        <Section title="Hébergement">
          <p>
            Ce site est hébergé via des services tiers conformes aux réglementations
            européennes en vigueur (RGPD).
          </p>
        </Section>

        <Section title="Données collectées">
          <p>
            NateSystem collecte uniquement les données nécessaires au fonctionnement
            des services proposés. Ces données peuvent inclure :
          </p>
          <ul
            style={{
              paddingLeft: '20px',
        ...
        <Section title="Politique de confidentialité">
          <p>
            Les données personnelles collectées ne sont jamais vendues, louées ou
            partagées avec des tiers à des fins commerciales.
          </p>
          <p>
            Vous disposez d&apos;un droit d&apos;accès, de rectification et de suppression de
            vos données personnelles. Pour exercer ces droits, contactez :{' '}
            <a
              href="mailto:nathan@natesystem.com"
              style={{ color: 'var(--color-gold)', textDecoration: 'none' }}
            >
        ...
        <Section title="Cookies">
          <p>
            ...
            fonctionnement. Aucun cookie publicitaire tiers n&apos;est déposé sans votre
        ...
        <Section title="Propriété intellectuelle">
          <p>
            L&apos;ensemble du contenu de ce site (textes, images, design, code) est la
            propriété exclusive de Nathan Goutagny — NateSystem. Toute reproduction
        ...
        <Section title="Limitation de responsabilité">
          <p>
            NateSystem s&apos;efforce d&apos;assurer l&apos;exactitude et la mise à jour des
            informations diffusées sur ce site. Toutefois, NateSystem ne peut garantir
      ...
      >
        <div className="flex items-center gap-1">
          ...
          />
          <span style={{ marginLeft: '8px', fontFamily: 'var(--font-body)' }}>
...
function Section({
  ...
  return (
    <div style={{ marginTop: '48px', marginBottom: '0' }}>
      <h2
        className="font-display italic"
        style={{
          fontSize: '22px',
