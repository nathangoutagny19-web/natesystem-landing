...
export default function LogicielInterneSaintEtiennePage() {
  return (
    <main>
      <Nav />
        ...
        <div className="mx-auto text-center" style={{ maxWidth: 820 }}>
          <FadeUp>
            ...
            <p className="font-sans" style={{ fontSize: 'clamp(15px, 3vw, 18px)', fontWeight: 300, color: 'var(--text-secondary)', maxWidth: 660, margin: '0 auto 36px', lineHeight: 1.65 }}>
              ...
              la Loire. Un seul logiciel pour réunir vos outils, vos données et votre équipe — que votre entreprise
              possède à vie.
            </p>
        ...
        <div className="mx-auto" style={{ maxWidth: 760 }}>
          ...
          <FadeUp>
            <p className="font-sans" style={{ fontSize: 16, color: 'var(--text-secondary)', lineHeight: 1.75, fontWeight: 300, maxWidth: 680, margin: '0 auto', textAlign: 'center' }}>
              ...
              entre tableurs, mails et outils déconnectés : gestion, données, équipe, pilotage. À Saint-Étienne, NateSystem
      ...
      <section style={{ padding: '70px 24px' }}>
        <div className="mx-auto" style={{ maxWidth: 760 }}>
          <FadeUp className="text-center mb-8">
            <h2 className="section-title" style={{ maxWidth: 640, margin: '0 auto' }}>
              Proche des entreprises <span className="accent">de la Loire.</span>
            </h2>
          </FadeUp>
          <FadeUp>
            <p className="font-sans" style={{ fontSize: 15.5, color: 'var(--text-secondary)', lineHeight: 1.75, fontWeight: 300, maxWidth: 680, margin: '0 auto 16px', textAlign: 'center' }}>
              NateSystem accompagne les entreprises et PME de Saint-Étienne et de la Loire. On commence par comprendre votre
              métier sur le terrain, puis on construit le logiciel interne qui correspond à vos vrais besoins, avec un
              interlocuteur proche et disponible.
            </p>
            <p className="font-sans" style={{ fontSize: 15.5, color: 'var(--text-secondary)', lineHeight: 1.75, fontWeight: 300, maxWidth: 680, margin: '0 auto', textAlign: 'center' }}>
              Agence basée à <Link href="/logiciel-interne-lyon" style={{ color: 'var(--accent)', textDecoration: 'none' }}>Lyon</Link>, on
              intervient dans toute l&apos;Auvergne-Rhône-Alpes. Le développement se fait à distance et en présentiel selon
              vos besoins.
            </p>
          </FadeUp>
        </div>
        ...
        <div className="mx-auto" style={{ maxWidth: 760 }}>
          ...
          <div style={{ display: 'grid', gap: 22, maxWidth: 680, margin: '0 auto' }}>
            {[
              ...
              {
                q: 'Combien coûte un logiciel interne à Saint-Étienne ?',
                a: 'Le prix dépend du périmètre, des intégrations et de l\'IA. Pour une PME stéphanoise, une première version utile se situe entre quelques milliers et quelques dizaines de milliers d\'euros. On chiffre l\'impact avant le devis, pendant l\'audit offert.',
              },
              {
                q: 'NateSystem intervient-il à Saint-Étienne ?',
                a: 'Oui. NateSystem, agence basée à Lyon, accompagne les entreprises de Saint-Étienne, de la Loire et de toute l\'Auvergne-Rhône-Alpes. Le travail se fait à distance et en présentiel selon les besoins.',
              },
            ].map((item) => (
              <div key={item.q}>
      ...
      <RelatedLinks
        links={[
          ...
          { href: '/agence-logiciel-ia-lyon', label: 'Agence logiciel & IA à Lyon', desc: 'Notre offre complète.' },
          ...
          <FadeUp>
            <div style={{ background: 'var(--bg-card)', border: '1px solid rgba(230,57,70,0.15)', borderRadius: 12, padding: '48px 40px', textAlign: 'center' }}>
              <h2 className="font-serif italic" style={{ fontSize: 'clamp(24px, 4vw, 32px)', fontWeight: 400, marginBottom: 16, color: 'var(--text)' }}>
                Votre logiciel interne, à Saint-Étienne.
              </h2>
