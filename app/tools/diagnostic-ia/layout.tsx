...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://studio.natesystem.com/tools/diagnostic-ia' },
  openGraph: {
    title: 'Le Diagnostic IA, par NateSystem',
    description:
    ...
    url: 'https://studio.natesystem.com/tools/diagnostic-ia',
    type: 'website',
  },
}
...
const jsonLd = {
  ...
  '@type': 'WebApplication',
  '@id': 'https://studio.natesystem.com/tools/diagnostic-ia#app',
