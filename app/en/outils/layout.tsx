...
/**
 * MÉTADONNÉES DE `/en/outils`.
 *
 * Sans ce layout, la route hériterait de `app/en/layout.tsx` : titre d'accueil
 * et canonique pointant sur `/en`. La page serait dans le sitemap sans être
 * indexable sous sa propre adresse. Le JSON-LD est l'équivalent anglais de
...
export default function EnOutilsLayout({ children }: { children: React.ReactNode }) {
  return (
    <>
