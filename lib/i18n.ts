export const translations = {
  ...
  'nav.svc.sprint': { en: 'Operational consulting', fr: 'Consulting opérationnel' },
  'nav.svc.sprintDesc': { en: 'We map your processes and find where you gain the most', fr: 'On cartographie vos process et on repère où vous gagnez le plus' },
  'nav.svc.logiciel': { en: 'Custom system', fr: 'Système sur-mesure' },
  'nav.svc.logicielDesc': { en: 'The software or cockpit built for your trade', fr: 'Le logiciel ou cockpit taillé pour votre métier' },
  'nav.svc.ia': { en: 'AI & automation', fr: 'IA et automatisation' },
  'nav.svc.iaDesc': { en: 'AI and automation where they replace real hours', fr: 'L\'IA et l\'automatisation là où elles remplacent de vraies heures' },
  'nav.svc.audit': { en: 'Training & support', fr: 'Formation & accompagnement' },
  'nav.svc.auditDesc': { en: 'We train your teams all the way to autonomy', fr: 'On forme vos équipes jusqu\'à l\'autonomie complète' },
  ...
  'hero.titlePrefix': { en: 'We build your custom software & AI systems that boost your', fr: 'On construit vos logiciels & systèmes IA sur-mesure qui vous font gagner en' },
