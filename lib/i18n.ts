export const translations = {
  ...
  'problem.stat': {
    ...
    fr: '~15h/semaine perdues par manager en coordination manuelle — environ 25 000 €/an par personne.',
  },
  ...
  'solution.sub': {
    en: 'Not a template. Not a SaaS subscription. A command center designed around how you actually operate — with AI built in only where it replaces real hours of work.',
    fr: 'Pas un template. Pas un abonnement SaaS. Un poste de commandement pensé autour de votre façon réelle d\'opérer — avec l\'IA intégrée uniquement là où elle remplace de vraies heures de travail.',
  },
  ...
  'solution.automateDesc': {
    en: 'Dashboards, order views, client portals, internal tools — each screen built for the job it serves. No feature bloat, no menus you\'ll never open.',
    fr: 'Dashboards, vues commandes, portails clients, outils internes — chaque écran pensé pour la tâche qu\'il sert. Pas de feature bloat, pas de menus qu\'on n\'ouvre jamais.',
  },
  ...
  'testimonial.caption': {
    en: 'Catherine P., General Manager, walks through the real operational change after deployment.',
    fr: 'Catherine P., General Manager, détaille le changement opérationnel concret après déploiement.',
  },

  // Process
  'process.label': { en: 'How we work', fr: 'Comment on travaille' },
  'process.title': { en: 'First we map. Then we build.', fr: 'D\'abord on cartographie. Ensuite on construit.' },
  'process.titleAccent': { en: 'Then we deploy.', fr: 'Enfin on déploie.' },
  'process.sub': {
  ...
  'process.step2': { en: 'Then — Build', fr: 'Ensuite — Construction' },
  'process.step2Duration': { en: '4 to 8 weeks', fr: '4 à 8 semaines' },
  'process.step2Desc': {
    en: 'We build your custom software and integrate AI around your business. Unified database, dashboards, agentic AI, automation, data analytics, integrations. Fixed scope, fixed price, weekly demos.',
    fr: 'On construit votre logiciel sur-mesure et on y intègre l\'IA sur votre métier. Base de données unifiée, dashboards, IA agentique, automatisation, data analytics, intégrations. Périmètre fixe, prix fixe, démos hebdomadaires.',
  },
  'process.step3': { en: 'Finally — Deploy', fr: 'Enfin — Déploiement' },
  'process.step3Duration': { en: '30-day support included', fr: 'Support 30 jours inclus' },
  'process.step3Desc': {
  ...
  'process.step3Highlight': { en: 'Autonomy & continuous learning', fr: 'Autonomie & apprentissage continu' },
  ...
  // Solution 1 — Plateforme Dédiée
  'sols.s1.badge': { en: '', fr: '' },
  'sols.s1.title': { en: 'Dedicated Platform', fr: 'Plateforme Dédiée' },
  'sols.s1.target': { en: '', fr: '' },
  'sols.s1.promise': {
    en: 'We build the custom software that runs your business — with AI integrated where it really helps, or without if it doesn\'t. The system belongs to you for life.',
    fr: 'On construit le logiciel sur-mesure qui pilote votre activité — avec l\'IA intégrée là où elle apporte vraiment, ou sans si ça n\'a pas d\'intérêt. Le système vous appartient à vie.',
  },
  'sols.s1.bullet1': { en: 'Complete mapping of your business in audit', fr: 'Cartographie complète de votre métier en audit' },
  'sols.s1.bullet2': { en: 'Unified database + custom interfaces', fr: 'Base de données unifiée + interfaces sur-mesure' },
  'sols.s1.bullet3': { en: 'AI integrated only where it replaces real hours', fr: 'IA intégrée uniquement là où elle remplace de vraies heures' },
  'sols.s1.bullet4': { en: 'Source code delivered · 100% ownership', fr: 'Code source livré · Propriétaire à 100%' },
  'sols.s1.bullet5': { en: 'Modern stack: Next.js + Supabase + Claude API', fr: 'Stack moderne : Next.js + Supabase + Claude API' },
  'sols.s1.bullet6': { en: 'In production in 4 to 8 weeks · Hosted in the EU · GDPR-native', fr: 'En production en 4 à 8 semaines · Hébergé en UE · RGPD-natif' },
  'sols.s1.ideal': {
  ...
  'sols.s2.title': { en: 'AI Ecosystem', fr: 'Écosystème IA' },
  ...
  'sols.s2.bullet1': { en: 'Audit of your current processes', fr: 'Audit de vos process actuels' },
  'sols.s2.bullet2': { en: 'Progressive deployment of the 5 systems', fr: 'Déploiement progressif des 5 systèmes' },
  'sols.s2.bullet3': { en: 'Team training for autonomy', fr: 'Formation de vos équipes' },
  'sols.s2.bullet4': { en: 'Compatible with your existing tools — Notion, HubSpot, Pipedrive, Slack, Teams, and others', fr: 'Compatible avec vos outils existants — Notion, HubSpot, Pipedrive, Slack, Teams, et d\'autres' },
  'sols.s2.bullet5': { en: 'Your data stays in the EU · GDPR-compatible', fr: 'Vos données restent en UE · Compatible RGPD' },
  'sols.s2.bullet6': { en: 'ROI measured from the first week', fr: 'ROI mesuré dès la première semaine' },
  'sols.s2.ideal': {
  ...
  'sols.s3.title': { en: 'Audit & Action Plan', fr: 'Audit & Plan d\'Action' },
  ...
  'sols.s3.bullet1': { en: 'Half-day mapping of your processes', fr: 'Demi-journée de mapping de vos process' },
  'sols.s3.bullet2': { en: 'Identification of 3-5 priority AI levers', fr: 'Identification des 3-5 leviers IA prioritaires' },
  'sols.s3.bullet3': { en: 'Costed plan: DIY / NateSystem / mix', fr: 'Plan chiffré : DIY / NateSystem / mix' },
  'sols.s3.bullet4': { en: 'Tech stack recommendations', fr: 'Recommandations stack technique' },
  'sols.s3.bullet5': { en: '15-25 page document delivered within 7 days', fr: 'Document de 15-25 pages livré sous 7 jours' },
  'sols.s3.bullet6': { en: 'You leave with the plan, even without us', fr: 'Vous repartez avec le plan, même sans nous' },
  'sols.s3.ideal': {
  ...
  'sols.s3.cta': { en: 'Book 20 min', fr: 'Réserver 20 min' },
  'sols.s3.ctaSub': { en: 'Fixed price · Delivered within 7 days', fr: 'Forfait fixe · Livré sous 7 jours' },
  // Common labels
  ...
  'fomo.stat1.desc': { en: 'of EU enterprises (10+ employees) use AI in 2025 — up from 13.5% in 2024, a +48% jump in a single year.', fr: 'des entreprises européennes (10+ employés) utilisent l\'IA en 2025 — vs 13,5% en 2024, soit +48% en un an.' },
  ...
  'agents.sub': {
    en: 'Not a generic AI layer bolted on top. Agentic AI, automation and data analytics embedded inside the software, configured for your business, deployed on your infrastructure — each one taking on a precise role.',
