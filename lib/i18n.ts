export const translations = {
  ...
  'process.step1Desc': {
    en: 'We start with a free call to understand your situation. Then, in the audit, we map your processes, structure everything (who does what, in what order) and pinpoint where we can save you time. You leave with a clear, costed plan, even if we don\'t work together.',
  ...
  'trans.gainVal1': { en: '1 tool', fr: '1 outil' },
  'trans.gainDesc1': { en: 'Everything in one place — no more tools that ignore each other.', fr: 'Tout réuni au même endroit — fini les outils qui ne se parlent pas.' },
  'trans.gainVal2': { en: 'Tailored', fr: 'Sur-mesure' },
  'trans.gainDesc2': { en: 'Built around your business, not a generic SaaS you\'re squeezed into.', fr: 'Taillé pour votre métier, pas un SaaS générique où vous rentrez au chausse-pied.' },
  'trans.gainVal3': { en: '100 %', fr: '100 %' },
  'trans.gainDesc3': { en: 'Your knowledge and code live in the system, owned by you — not in one head.', fr: 'Le savoir et le code vivent dans le système, à vous — plus dans une seule tête.' },
