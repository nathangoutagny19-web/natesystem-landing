        ...
        html: `
          <div style="font-family: -apple-system, sans-serif; max-width: 560px; margin: 0 auto; padding: 40px 24px;">
            ...
            <p style="margin-top: 16px;">
              <a href="https://cal.com/goutagny-nathan-myv1qd/45min" style="display: inline-block; padding: 14px 28px; background: #ED4245; color: #fff; text-decoration: none; border-radius: 10px; font-weight: 600; font-size: 14px;">
